...
import { FaMapMarkerAlt, FaWhatsapp, FaEnvelope, FaPhoneAlt } from "react-icons/fa";
      ...
      <div className="relative w-full max-w-4xl bg-gray-800 rounded-3xl shadow-lg p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          ...
          <div className="flex flex-col items-center text-center bg-gray-700 p-4 rounded-lg shadow">
            ...
            <p className="mt-2 text-green-400 font-semibold flex items-center">
              Emboss me <FaArrowRight className="ml-2" />
            </p>
          </div>
